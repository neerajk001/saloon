    ...
    return (
        ...
        >
            <div className="max-w-full md:max-w-[800px] z-10 opacity-0 translate-y-8 animate-fade-up w-full flex flex-col items-center justify-center">
                <h1 className="font-serif text-3xl sm:text-4xl md:text-6xl lg:text-7xl text-white mb-12 md:mb-12 -tracking-[0.02em] leading-tight">
                    Elevated Hair & Beauty Experience
                </h1>

                <div className="grid grid-cols-2 gap-2 sm:gap-3 md:gap-6 w-full px-2 sm:px-4 max-w-md sm:max-w-2xl">
