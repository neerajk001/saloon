    ...
    return (
        <section id="book" className="py-32 px-8 bg-secondary text-center">
            <div className="max-w-[800px] mx-auto">
                ...
                <a
                    href="#"
                    className="inline-flex items-center gap-3 px-12 py-4 bg-[#f28c28] text-white font-sans text-sm uppercase tracking-[0.15em] transition-all duration-300 shadow-md hover:bg-[#e47910] hover:-translate-y-1 hover:shadow-xl rounded-full"
                >
